...
# ============================================================
# CẤU HÌNH HARDWARE (MẶC ĐỊNH)
# ============================================================
MOCK_HARDWARE = os.getenv('MOCK_HARDWARE', 'yes').lower() == 'yes'
URL_IR_SENSOR_IN = os.getenv('URL_IR_SENSOR_IN', "http://192.168.1.100/ir_in")
URL_IR_SENSOR_OUT = os.getenv('URL_IR_SENSOR_OUT', "http://192.168.1.100/ir_out")
URL_ESP32_CAPTURE_IN = os.getenv('URL_ESP32_CAPTURE_IN', "http://192.168.1.101/capture")
URL_ESP32_CAPTURE_OUT = os.getenv('URL_ESP32_CAPTURE_OUT', "http://192.168.1.102/capture")
URL_BARRIER_OPEN = os.getenv('URL_BARRIER_OPEN', "http://192.168.1.100/open")
