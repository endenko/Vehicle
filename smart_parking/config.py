...
# Thư mục lưu ảnh theo quy trình OCR (đặt tên file bằng text_ocr)
LICH_SU_XE_VAO_DIR = BASE_DIR / "Lich_su_xe_vao"
LICH_SU_XE_RA_DIR = BASE_DIR / "Lich_su_xe_ra"

for dir_path in [EVIDENCE_DIR, EVIDENCE_IN_DIR, EVIDENCE_OUT_DIR, ESP32_INBOX_DIR,
                 LICH_SU_XE_VAO_DIR, LICH_SU_XE_RA_DIR]:
    dir_path.mkdir(parents=True, exist_ok=True)
...
# CẤU HÌNH API SERVER
# ============================================================
API_HOST = os.getenv('API_HOST', '0.0.0.0')  # Server bind (0.0.0.0 = LAN accessible)
API_PORT = int(os.getenv('API_PORT', 8000))
# GUI luôn connect qua localhost, dù server bind 0.0.0.0
API_ENDPOINT = f"http://127.0.0.1:{API_PORT}"
...
# ============================================================
# CẤU HÌNH HARDWARE — ESP32 THẬT (Đã tắt MOCK)
# ============================================================
MOCK_HARDWARE = os.getenv('MOCK_HARDWARE', 'no').lower() == 'yes'
ESP32_IP = os.getenv('ESP32_IP', '10.202.90.61')
URL_IR_SENSOR_IN = os.getenv('URL_IR_SENSOR_IN', f"http://{ESP32_IP}/ir_in")
URL_IR_SENSOR_OUT = os.getenv('URL_IR_SENSOR_OUT', f"http://{ESP32_IP}/ir_out")
URL_ESP32_CAPTURE_IN = os.getenv('URL_ESP32_CAPTURE_IN', f"http://{ESP32_IP}/capture")
URL_ESP32_CAPTURE_OUT = os.getenv('URL_ESP32_CAPTURE_OUT', f"http://{ESP32_IP}/capture")
URL_BARRIER_OPEN = os.getenv('URL_BARRIER_OPEN', f"http://{ESP32_IP}/open")
