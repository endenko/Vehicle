                ...
                for img in candidates:
                    ...
                    if decoded:
                        for item in decoded:
                            ...
                            dtype = "qr" if "{" in code else "barcode"
                            display_text = "SMARTPARKING" if dtype == "qr" else code
                ...
                for img in candidates + [frame]:
                    ...
                    if data:
                        ...
                        if bbox is not None and len(bbox) > 0:
                            ...
                            cv2.putText(frame, "SMARTPARKING (CV2 QR)", (x, max(18, y - 6)), cv2.FONT_HERSHEY_SIMPLEX, 0.55, (0, 255, 0), 2, cv2.LINE_AA)
                        self._emit_detection("qr", data, 99.0, "cv2")
                        ...
                        if ok and decoded_info:
                            for i, bcode in enumerate(decoded_info):
                                if bcode:
                                    ...
                                    self._emit_detection("barcode", bcode, 99.0, "cv2")
