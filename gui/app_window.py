...
class MainApp(ctk.CTk):
    def __init__(self):
        ...
        ctk.CTkLabel(
            logo_frame,
            text="SPM School Parking Management",
        ...
        try:
            self.tabview._segmented_button.configure(
                ...
                selected_color=AppStyle.PRIMARY,
                selected_hover_color=AppStyle.PRIMARY_DARK,
                unselected_color=AppStyle.SURFACE,
                unselected_hover_color=AppStyle.CARD_BG_HOVER,
