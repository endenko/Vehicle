...
class AppStyle:
    ...
    # ── Tab active colors (Yêu cầu 6: hài hòa hơn) ───────────────────────
    TAB_ACTIVE       = "#1D4ED8"   # Xanh đậm cho tab đang chọn
    TAB_ACTIVE_HOVER = "#1E40AF"   # Hover cho tab đang chọn
    TAB_INACTIVE     = "#E2E8F0"   # Tab không chọn (xám nhạt)
    TAB_INACTIVE_HOVER = "#CBD5E1"
